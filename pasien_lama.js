...
export function renderCariPasienLama() {
    return `
...
export function eksekusiCariPasien() {
    updateDatabase();
...
export function daftarkanLamaLagi(id) {
    updateDatabase();
...
window.eksekusiCariPasien = eksekusiCariPasien;
window.daftarkanLamaLagi = daftarkanLamaLagi;
